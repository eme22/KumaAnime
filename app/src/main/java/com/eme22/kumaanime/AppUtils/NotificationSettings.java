...
public class NotificationSettings {
    ...
    public static String CHANNEL_DOWNLOADS = "download_id";
    ...
    public static void initializeNotificationManager(Context context) {
        ...
        maximumNotification = new PrefManager(context).getInt(context.getString(R.string.key_maximum_notification), 25);
    ...
    public static void notify(String channel, int notificationId, Notification notification) {
        ...
        trimArray();
        Log.d("Notification count: " , String.valueOf(notificationArray.size()));
