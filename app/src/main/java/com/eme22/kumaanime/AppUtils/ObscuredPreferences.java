...
import static com.eme22.kumaanime.BuildConfig.KEY666;


public class ObscuredPreferences implements SharedPreferences{
    protected static final String UTF8 = "utf-8";
    private static final char[] SEKRIT = KEY666.toCharArray();


    protected SharedPreferences delegate;
    protected Context context;

    public ObscuredPreferences(Context context, SharedPreferences delegate) {
    ...
    public class Editor implements SharedPreferences.Editor {
        ...
        public Editor() {
            this.delegate = ObscuredPreferences.this.delegate.edit();
        }
        ...
        public SharedPreferences.Editor putStringSet(String key, @Nullable Set<String> value) {
            return delegate.putStringSet(key, value);
        }
    ...
    public Set<String> getStringSet(String s, @Nullable Set<String> set) {
        return delegate.getStringSet(s, set);
    }
